...
**Approval Record:** GOV-011  
**Amendment Record:** GOV-010  
...
**Supersedes:** None  
**Superseded By:** IMP-001 v1.2 under GOV-032
...
| FIL protection realization | Threat model, P1–P4 mapping, mutual transport identity, message protection, downgrade prevention, and encrypted recovery |
...
|---|---|---|---|
| Project Owner | Approved | GOV-011 | 2026-07-24 |
