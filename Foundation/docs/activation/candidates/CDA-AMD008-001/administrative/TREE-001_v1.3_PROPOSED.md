...
| AWR-006 | Self-Awareness | `docs/specifications/self-awareness/AWR-006_MAIN_SELF_AWARENESS.md` | proposed successor |
| AWR-007 | Self-Awareness | `docs/specifications/self-awareness/AWR-007_LOCAL_SELF_AWARENESS.md` | proposed successor |
| AWR-008 | Self-Awareness | `docs/specifications/self-awareness/AWR-008_COMPONENT_SELF_AWARENESS.md` | proposed successor |
...
| SYS-003 | OS Foundation | `docs/specifications/foundation/SYS-003_FOUNDATION_SERVICE_OWNERSHIP_AND_CATALOG.md` | proposed successor |
| SYS-004 | OS Foundation | `docs/specifications/foundation/SYS-004_APPLICATION_DEPENDENCY_GOVERNANCE.md` | proposed successor |
| SYS-005 | OS Foundation | `docs/specifications/core/SYS-005_SERVICE_BUS.md` | current effective |
| SYS-006 | OS Foundation | `docs/specifications/foundation/SYS-006_MULTI_LEVEL_RESOURCE_GOVERNANCE.md` | proposed successor |
...
| APP-001 | Applications | `docs/specifications/applications/APP-001_APPLICATION_BOUNDARY_AND_LIFECYCLE.md` | proposed successor |
