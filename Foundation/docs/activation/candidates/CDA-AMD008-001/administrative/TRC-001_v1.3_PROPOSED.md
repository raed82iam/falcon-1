...
# TRC-001 — Requirement-to-Verification Traceability Matrix

**Identifier:** TRC-001  
**Version:** 1.3 Proposed  
**Status:** Proposed  
**Canonical Target:** `docs/traceability/TRC-001_FOUNDATION_REQUIREMENT_TO_VERIFICATION_TRACEABILITY_MATRIX.md`  
**Approval Record:** Pending  
**Owner:** Falcon Traceability Governance  
**Governing Authority:** Falcon Vision; Falcon Constitution; GOV-063; TREE-001; VPL-005  
...
TRC-001 defines the governed traceability structure between requirements and verification evidence for the AMD-008 alignment package.
...
- treat a proposed document as active.

## 4. Normative Requirements

- **TRC-001-REQ-001:** Every governed requirement SHALL have one canonical trace row.
- **TRC-001-REQ-002:** Every trace row SHALL identify source version and current controlling version where applicable.
- **TRC-001-REQ-003:** Historical requirements preserved through supersession SHALL remain traceable.
- **TRC-001-REQ-004:** A trace SHALL distinguish current effective, proposed successor, historical, and no-change states.
- **TRC-001-REQ-005:** A trace SHALL not infer verification success from document presence.
- **TRC-001-REQ-006:** A trace SHALL remain reconstructable from the preserved source documents.
- **TRC-001-REQ-007:** A trace SHALL reject orphan, duplicate, ambiguous, or conflicting lineages.

## 5. AMD-008 Alignment

The traceability proposal SHALL include:

- AWR-001 through AWR-008 alignment;
- CON-002, CON-006, EVO-001, VPL-005, FDN-001, FDN-002, and FDN-004 disposition;
- SPEC-000, CON-000, ADR-000, TREE-001, GOV-002, Core README, Concept AR, GLO-001, ROADMAP-001, and FRS-001-READINESS projected transitions; and
- the CDA proposal records as trace evidence only.

## 6. Invariants

1. Traceability is not execution.
2. A proposed successor is not an active evidence source.
3. Lineage must be explicit.
4. Missing trace is a visible gap.

## 7. Acceptance Evidence

Acceptance requires a stable trace row for each governed subject and no ambiguous lineage.

## 8. Preservation Matrix

| Traceability area | Status | Evidence of preservation |
|---|---|---|
| Purpose and scope | Preserved | sections 1–3 remain intact and governing |
| Normative requirements | Preserved | section 4 retains the traceability rules |
| AMD-008 alignment and invariants | Preserved | sections 5–6 retain the complete alignment and trace rules |
