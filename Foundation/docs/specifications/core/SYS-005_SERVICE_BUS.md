...
- **SYS-005-REQ-016:** Every route crossing a security boundary SHALL enforce the minimum SEC-PLAN-001 protection profile before admission.
- **SYS-005-REQ-017:** Transport endpoint identity SHALL be mutually verified and bound to the producer, consumer, or authorized intermediary.
- **SYS-005-REQ-018:** The Service Bus SHALL preserve original protection metadata and SHALL NOT weaken end-to-end payload protection without explicit authority.
...
- **SYS-005-REQ-020:** Unknown profile, failed channel authentication, downgrade, invalid integrity, wrong recipient, stale revocation, or prohibited replay SHALL cause explicit rejection.
...
- **SYS-005-REQ-022:** Transport evidence SHALL record protection profile, endpoint identities, key references, and results without exposing keys or sensitive plaintext.
